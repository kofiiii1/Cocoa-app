...
class BuyerRegister : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        info2 = findViewById(R.id.Binfo2)
        mName = findViewById(R.id.Bname)
        mEmail = findViewById(R.id.Bemail)
        mContact = findViewById(R.id.Bcontact)
        mUsername = findViewById(R.id.Busername)
        mPassword = findViewById(R.id.Bpassword)
        mRegisterButton = findViewById(R.id.Bregister_btn)
        ...
        mRegisterButton.setOnClickListener {
            ...
            if (isInserted) {
                Toast.makeText(this, "Buyer registered successfully!", Toast.LENGTH_SHORT).show()
        ...
        info2.setOnClickListener {
            val intent = Intent(this@BuyerRegister, BuyerLogin::class.java)
            startActivity(intent)
        }
    }
